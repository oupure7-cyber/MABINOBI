...
- 요리는 야채볶음과 추가 요리 9종(각 10개/50개), 제작은 장비 12종(각 3개)을 제공합니다. 새 작업은 게임 레시피를 조회하며 부족한 채집·제작 재료를 준비합니다. 별도 가공·구매 재료나 해금 조건이 부족하면 멈춥니다. 새 레시피는 1회씩 제작하므로 호출마다 정령의 날개가 소모됩니다. 게임이 꺼져 있어 새 요리·장비의 실제 게임 제작은 아직 검증하지 못했습니다.
